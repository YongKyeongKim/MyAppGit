...
<div class="jumbotron jumbotron-fluid bg-warning">
	<div class="container-fluid">
		<h1>
			자료실 작성<small>자료파일을 등록 하세요</small>
		</h1>
	</div>
	<!--jumbotron-->
</div>
<!--container-->
<div class="container">
	<form method="post" action="<c:url value="/DataRoom/Write.kosmo"/>" enctype="multipart/form-data">      
      ...
      <div class="form-group">
        <label><kbd class="lead">자료파일</kbd></label>
       	<input type="file"   class="form-control-file" name="attachFile">       
      </div>
      <div class="form-group">
