...
public class SessionAttributeController {
	...
	//로그인 여부 판단]
	@RequestMapping("/SessionAttributeIsLogin.do")
	...
	public String error(Model model) {
		model.addAttribute("isLoginMessage", "로그인후 이용하세요");
		//뷰정보 반환]
		return "annotation06/Annotation";
	}//////////////
	/*
	...
	//로그인 여부 판단]세션 영역에 반드시 "id"라는 속성(키가) 존재 해야 한다.그렇지 않으면 에러(Expected session attribute 'id')
	@RequestMapping("/SessionAttributeIsLogin.do")
